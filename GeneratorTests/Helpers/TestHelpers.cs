...
internal static class TestHelpers
{
    ...
    [
        new CsvIncrementalGenerator()
    ];

    private static readonly string[] GeneratedAttributeFileNames =
    [
        "CsvIncrementalSerializableAttribute.g.cs"
    ];

    public static string LoadEmbeddedAttribute()
        => LoadEmbeddedResource("CsvIncrementalSerializableAttribute.g.cs");
    ...
    public static (ImmutableArray<Diagnostic> Diagnostics, string Output) GetGeneratedOutput(IIncrementalGenerator[] generators, Options opts)
    {
        ...
        var output = string.Join("\r\n", trees.WhereNotGeneratedAttribute());
        ...
        IIncrementalGenerator[] generators, Options opts, params string[] stages)
    {
        ...
        var references = AppDomain.CurrentDomain.GetAssemblies()
            ...
            .Concat([
                ...
                MetadataReference.CreateFromFile(typeof(Generators.CsvIncrementalGenerator).Assembly.Location),
               // MetadataReference.CreateFromFile(typeof(CsvIncrementalSerializableAttribute).Assembly.Location),
